...
python examples/render_sgmesh.py --scene_name=scene0406_00_vh_clean_2 --task_name=scene_understanding/comparsion_material/ours/0406_00 
python examples/render_sgmesh.py --render_seg --scene_name=scene0406_00_vh_clean_2 --task_name=scene_understanding/comparsion_material/ours/0406_00 
python examples/render_sgmesh.py --scene_name=scene0406_00_vh_clean_2 --task_name=scene_understanding/comparsion_material/openscene/0406_00 
python examples/render_sgmesh.py --render_seg --scene_name=scene0406_00_vh_clean_2 --task_name=scene_understanding/comparsion_material/openscene/0406_00 
"""
import argparse
import os
import json
...
def parse_args():
    ...
    parser.add_argument(
        "--task_name",
        type=str,
        default="scene_understanding/teaser_material/0011_01",
...
def find_auxiliary_file(scene_name, task_name, pcd_path, file_type, custom_path=None):
    ...
    if task_name:
        ...
        for pattern in file_patterns[file_type]:
            search_paths.append(os.path.join('data', base_root, folder_id, pattern))
